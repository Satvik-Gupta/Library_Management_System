...
if(isset($_POST['Return_Date'])){
    ...
    $sql1="INSERT INTO Borrower_Details values ('$Student_Id' , '$Borrowed_From', '$Return_Date', $ISBN_Code)";
    $sql2="UPDATE Book_Details SET No_Copies_Current = (No_Copies_Current-1) WHERE ISBN_Code=$ISBN_Code";


    if(($con->query($sql1) == TRUE)&&($con->query($sql2) == TRUE)){
        $prompt_msg = "Book Issued Successfully";
        prompt($prompt_msg);


    }
    else{
        $prompt_msg = "Error in Issuing Book";
        prompt($prompt_msg);
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <div class="w3-container" id="Starting" style="margin-top:80px">
        <h1 class="w3-jumbo"><b>Book Issue</b></h1>
    </div>
    ...
    <div class="w3-container" id="Forum" style="margin-top:75px">
        ...
        <form action="Book_Issue.php" method="post">
            ...
            <div class="w3-section">
                ...
                <input class="w3-input w3-border" type="date" name="Borrowed_From" required>
            </div>
            <div class="w3-section">
